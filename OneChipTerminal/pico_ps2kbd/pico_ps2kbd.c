...
static volatile uint8_t altkey;
...
uint8_t pico_ps2kbd_altkey(void) { return altkey; }

void pico_ps2kbd_init(void) {
    state = curbyte = paritybit = shiftkey = ctrlkey = altkey = lastkeyup = 0;
