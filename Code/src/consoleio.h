...
//
// Ported from ParanoiaBox consoleio: the whole API is unchanged, so the editor
// and menus port unmodified. Output goes through the TNTSCAnsi VT100 emulator
// into a character buffer, which is diffed and blitted into the pico_ntsc
// framebuffer. Input comes from the PS/2 keyboard (or USB serial, for testing).
#ifndef _CONSOLEIO_H
#define _CONSOLEIO_H
